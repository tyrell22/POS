...
public class FloorPlanController {
    ...
    public ResponseEntity<?> addTableToArea(@PathVariable Long areaId, @RequestBody Map<String, Object> tableData) {
        try {
            ...
            Integer x = extractInteger(tableData, "positionX", 0);
            Integer y = extractInteger(tableData, "positionY", 0);
            Integer width = extractInteger(tableData, "width", 80);
            Integer height = extractInteger(tableData, "height", 80);
            
            // Add position and size to table data
            tableData.put("positionX", x);
            tableData.put("positionY", y);
            tableData.put("width", width);
            tableData.put("height", height);
