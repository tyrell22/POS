...
export const orderAPI = {
    ...
    // NEW: Remove item from order with admin code - FIXED
...
// Area API - FIXED to use correct endpoints
export const areaAPI = {
    ...
    // FIXED: Update table using the correct TableController endpoint
    updateTable: (tableId, tableData) => api.put(`/tables/${tableId}`, tableData),

    // FIXED: Update table position using the correct TableController endpoint
    updateTablePosition: (tableId, position) => api.patch(`/tables/${tableId}/position`, position),

    // FIXED: Delete table using the correct TableController endpoint
    deleteTable: (tableId) => api.delete(`/tables/${tableId}`)
};

// Table API (new endpoints for table management)
